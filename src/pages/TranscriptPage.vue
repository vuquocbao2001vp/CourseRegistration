<template>
  <div class="transcript-page">
    ...
    <div class="transcript-total">
      <div class="transcript-total-title">Tổng tín chỉ: {{totalCredit}}</div>
      <div class="transcript-total-title">Số tín chỉ tích lũy: {{accumulatedCredit}}</div>
      <div class="transcript-total-title">Điểm trung bình: {{accumulatedScore}}</div>
    </div>
  </div>
</template>
